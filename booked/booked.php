...
define( 'BOOKED_CF_VERSION', '1.1.3' );
...
if(!class_exists('booked_plugin')) {
	class booked_plugin {
		...
		public function __construct() {
			...
			require_once( BOOKED_PLUGIN_DIR . '/includes/add-ons/booked-frontend-agents/booked-frontend-agents.php' );
			require_once( BOOKED_PLUGIN_DIR . '/includes/add-ons/booked-woocommerce-payments/booked-woocommerce-payments.php' );
		...
		public function admin_scripts() {
			...
			if (in_array($current_page,$this->booked_screens) || $screen->id == 'dashboard' || $user_page ):
				...
				$booked_js_vars = array(
					...
					'i18n_update_appointment' => esc_html__('Update Appointment','wyzi-business-finder'),
					'i18n_create_appointment' => esc_html__('Create Appointment','wyzi-business-finder'),
					'i18n_all_day' => esc_html__('All day','wyzi-business-finder'),
					'i18n_enable' => esc_html__('Enable','wyzi-business-finder'),
					'i18n_disable' => esc_html__('Disable','wyzi-business-finder'),
					'i18n_change_date' => esc_html__('Change Date','wyzi-business-finder'),
