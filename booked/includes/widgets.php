...
class Booked_Calendar_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'booked_calendar', esc_html__('Booked Calendar','wyzi-business-finder'), $widget_ops );
	}
    ...
    function form($instance) {
		...
		<p>
	      	<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Widget Title','wyzi-business-finder'); ?>:</label>
	      	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
	    </p>
	    
	    <p class="booked-widget-col-13">
	      	<label><?php esc_html_e('Calendar to Display','wyzi-business-finder'); ?>:</label><br>
	    ...
	    <p class="booked-widget-col-13">
	      	<label><?php esc_html_e('Month','wyzi-business-finder'); ?>:</label><br>
	    ...
	    <p class="booked-widget-col-13">
	      	<label><?php esc_html_e('Year','wyzi-business-finder'); ?>:</label><br>
