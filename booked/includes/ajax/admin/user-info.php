...
echo '<div class="booked-scrollable">';
	...
	echo '<p class="booked-title-bar"><small>'.esc_html__('Edit Appointment','wyzi-business-finder').'</small></p>';
	...
	?><form action="" method="post" class="booked-form" id="editAppointmentForm" data-appt-id="<?php echo $appt_id; ?>"<?php if ($calendar_id): echo ' data-calendar-id="'.$calendar_id.'"'; endif; ?>><?php
		...
		if ( $appt_id ):
			...
			?><p class="booked-calendar-name"><?php esc_html_e( 'Appointment Date/Time', 'wyzi-business-finder'); ?></p><?php
			...
			?><p class="booked-calendar-name"><?php esc_html_e( 'Customer Information', 'wyzi-business-finder'); ?></p><?php
			...
			if (isset($name_requirements[0]) && $name_requirements[0] == 'require_surname'): ?>
				<div class="field">
					<input value="<?php echo $first_name; ?>" placeholder="<?php esc_html_e('First Name','wyzi-business-finder'); ?>..." type="text" class="textfield" name="name" />
					<input value="<?php echo $last_name; ?>" placeholder="<?php esc_html_e('Last Name','wyzi-business-finder'); ?>..." type="text" class="textfield" name="surname" />
				</div>
			<?php else: ?>
				<div class="field">
					<input value="<?php echo $first_name . ( $last_name ? ' ' . $last_name : '' ); ?>" placeholder="<?php esc_html_e('Name','wyzi-business-finder'); ?>..." type="text" class="large textfield" name="name" />
				</div>
			<?php endif;

			if ($customer_email):
				?><div class="field">
					<input value="<?php echo $customer_email; ?>" placeholder="<?php esc_html_e('Email Address','wyzi-business-finder'); ?>..." type="email" class="large textfield" name="email" />
				</div><?php
			endif;

			if ($customer_phone):
				?><div class="field">
					<input value="<?php echo $customer_phone; ?>" placeholder="<?php esc_html_e('Phone Number','wyzi-business-finder'); ?>..." type="tel" class="large textfield" name="phone" />
				</div><?php
			endif;

			echo '<hr>';

			?><p class="booked-calendar-name"><?php esc_html_e( 'Appointment Information', 'wyzi-business-finder'); ?></p><?php
			...
			?><div class="field">
				<input type="submit" class="button button-primary" value="<?php esc_html_e('Update Appointment','wyzi-business-finder'); ?>">
			</div><?php
