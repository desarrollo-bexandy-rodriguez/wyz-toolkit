	...
	class CPK_WPCSV {
		...
		public function admin_menus( ) {
			...
			if ( function_exists( 'add_menu_page' ) && function_exists( 'add_submenu_page' ) ) {
				add_submenu_page('edit.php?post_type=wyz_business', __('Import','wyzi-business-finder'), __('Import','menu-test'), $capability, 'wyz_business-import', Array( $this, 'import_page' ));	
				add_submenu_page('edit.php?post_type=wyz_location', __('Import','wyzi-business-finder'), __('Import','menu-test'), $capability, 'wyz_business-import', Array( $this, 'import_page' ));
				//add_submenu_page( 'wyzi-toolkit-options', __( 'Importer Settings', 'wyzi-business-finder' ), __( 'Importer Settings', 'wyzi-business-finder' ), $capability, 'wyzi-importer-settings', Array( $this, 'settings_page' ) );
				add_submenu_page( 'wyzi-toolkit-options-hidden', __( 'Report' ), __( 'Report' ), $capability, 'wyzi-report', Array( $this, 'report_page' ) );
				add_submenu_page( 'wyzi-toolkit-options-hidden', __( 'Download' ), __( 'Download' ), $capability, 'wyzi-download', Array( $this, 'download_page' ) );
			}
		}
